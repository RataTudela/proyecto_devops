...
1) Configurar kubectl contra tu cluster:
   aws eks update-kubeconfig --region us-east-1 --name Nombre_Cluster
...
Copias el EXTERNAL-IP (DNS del ELB) -> lo abres en el navegador -> deberías ver la página de Tienda de Despachos
